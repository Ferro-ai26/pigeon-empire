...
The current additions provide semantic placement validation, atomic cost debit, and a presentation-neutral construction decision. The executor does not create a building, reserve occupancy, apply storage, or introduce GUI, persistence, or export behavior.
